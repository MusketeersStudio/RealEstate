...
function listNameSpacesFromFolder($prefix,$dir,$suffix = null){
    $array = array();
    if (is_dir($dir)){
        if ($dh = opendir($dir)){
            while (($file = readdir($dh)) !== false){
                ...
                $type = strtolower($file[0] . $suffix);

                $array[$type] = $prefix . $file[0] . $suffix;
            }
            closedir($dh);
        }
    }
...
$mutations = listNameSpacesFromFolder('App\\GraphQL\\Mutation\\',"../app/GraphQL/Mutation");
$queries = listNameSpacesFromFolder('App\\GraphQL\\Query\\',"../app/GraphQL/Query");
$types = listNameSpacesFromFolder('App\\GraphQL\\Type\\',"../app/GraphQL/Type");
$enums = listNameSpacesFromFolder('App\\GraphQL\\Enums\\',"../app/GraphQL/Enums");
$inputTypes = listNameSpacesFromFolder('App\\GraphQL\\Type\\',"../app/GraphQL/Type","_Input");
$types = array_merge($types,$enums,$inputTypes);
